...
//#include "/apsarapangu/disk2/LogGrep_compression_zstd/LZMA/LzmaLib.h"
...
private:
	...
	int DeCompressCapsule(int patName, OUT Coffer* &coffer, int type=0);
	...
	inline int GetMatchedAlignType(int segSize, int curIndex);
